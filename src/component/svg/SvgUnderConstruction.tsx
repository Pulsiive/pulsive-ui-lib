...
const SvgUnderConstruction: FunctionComponent = () => {
    return (
        <svg
            id="Layer_1"
            data-name="Layer 1"
        ...
        >
            <defs>
                <linearGradient
                    id="svg-under-construction-linear-gradient"
                    x1="429.36"
                    y1="225.03"
                    x2="432.77"
                    y2="273.94"
                ...
                <linearGradient
                    id="svg-under-construction-linear-gradient-2"
                    x1="213.3"
                    y1="280.85"
                    x2="217.12"
                    y2="335.08"
                    xlinkHref="#svg-under-construction-linear-gradient"
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-3"
                    x1="160.76"
                    y1="309.98"
                    x2="263.86"
                    y2="289.64"
                ...
                <linearGradient
                    id="svg-under-construction-linear-gradient-4"
                    x1="231.52"
                    y1="309.98"
                    x2="334.62"
                    y2="289.64"
                    xlinkHref="#svg-under-construction-linear-gradient-3"
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-5"
                    x1="241.94"
                    y1="197.22"
                    x2="952.31"
                    y2="160.28"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-6"
                    x1="201.21"
                    y1="195.59"
                    x2="294.38"
                    y2="190.74"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-7"
                    x1="140.18"
                    y1="199.67"
                    x2="562.54"
                    y2="99.67"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-8"
                    x1="142.97"
                    y1="198.61"
                    x2="563.47"
                    y2="99.05"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-9"
                    x1="360.86"
                    y1="217.84"
                    x2="515.31"
                    y2="353.38"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-10"
                    x1="353.28"
                    y1="227.41"
                    x2="368.97"
                    y2="227.41"
                ...
                <linearGradient
                    id="svg-under-construction-linear-gradient-11"
                    x1="6.56"
                    y1="170.6"
                    x2="1891.15"
                    y2="72.59"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-12"
                    x1="-597.66"
                    y1="226.59"
                    x2="-578.4"
                    y2="226.59"
                    gradientTransform="matrix(-1, 0, 0, 1, -157.58, 0)"
                    xlinkHref="#svg-under-construction-linear-gradient-10"
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-13"
                    x1="426.9"
                    y1="207.42"
                    x2="441.17"
                    y2="225.32"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-14"
                    x1="429.31"
                    y1="203.21"
                    x2="464.72"
                    y2="247.62"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-15"
                    x1="429.46"
                    y1="203.41"
                    x2="455.91"
                    y2="236.58"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-16"
                    x1="428.66"
                    y1="214.36"
                    x2="358.06"
                    y2="244.79"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-17"
                    x1="-592.58"
                    y1="272.4"
                    x2="-583.59"
                    y2="272.4"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-18"
                    x1="426.36"
                    y1="328.05"
                    x2="444.16"
                    y2="190.58"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-19"
                    x1="131.97"
                    y1="78.14"
                    x2="131.97"
                    y2="78.14"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-20"
                    x1="105.96"
                    y1="81.66"
                    x2="457.71"
                    y2="-1.63"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-21"
                    x1="106.62"
                    y1="83.83"
                    x2="454.37"
                    y2="1.49"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-22"
                    x1="107.9"
                    y1="161.11"
                    x2="108.73"
                    y2="496.51"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-23"
                    x1="108.1"
                    y1="35.91"
                    x2="108.93"
                    y2="371.29"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-24"
                    x1="77.22"
                    y1="73.44"
                    x2="155.26"
                    y2="54.96"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-25"
                    x1="77.71"
                    y1="75.03"
                    x2="152.81"
                    y2="57.25"
                ...
                />
                <linearGradient
                    id="svg-under-construction-linear-gradient-26"
                    x1="122.05"
                    y1="354.33"
                    x2="61.88"
                    y2="381.87"
            ...
            <polygon
                ...
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient)"
            />
            <path
            ...
            <rect
                ...
                height="9.04"
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient-2)"
            />
            <rect
                x="243.21"
                y="287.01"
            ...
            <polygon
                ...
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient-3)"
            />
            <polygon
                points="243.42 323.73 253.38 323.73 253.38 289.62 243.21 289.62 243.42 323.73"
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient-4)"
            />
            <rect
                x="301.14"
                y="129.77"
            ...
            <rect
                ...
                height="124.2"
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient-7)"
            />
            <rect
                x="168.85"
                y="121.18"
            ...
            <path
                ...
                transform="translate(-1.64 -46.71)"
                fill="url(#svg-under-construction-linear-gradient-10)"
            />
            <path
            ...
            <path
                ...
                transform="translate(-1.64 -46.71)"
                fill="url(#svg-under-construction-linear-gradient-12)"
            />
            <path
            ...
            <path
                ...
                transform="translate(-1.64 -46.71)"
                fill="url(#svg-under-construction-linear-gradient-13)"
            />
            <path
            ...
            <path
                ...
                transform="translate(-1.64 -46.71)"
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient-14)"
            />
            <path
                ...
                transform="translate(-1.64 -46.71)"
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient-15)"
            />
            <polygon
            ...
            <polygon
                ...
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient-16)"
            />
            <path
                ...
                transform="translate(-1.64 -46.71)"
                fill="url(#svg-under-construction-linear-gradient-17)"
            />
            <polygon
            ...
            <polygon
                ...
                fill="url(#svg-under-construction-linear-gradient-18)"
            />
            <path
            ...
            <path
                d="M132,78.14"
                transform="translate(-1.64 -46.71)"
                fill="url(#svg-under-construction-linear-gradient-19)"
            />
            <rect
                x="207.32"
                y="77.87"
            ...
            <polygon
                ...
                fill="url(#svg-under-construction-linear-gradient-20)"
            />
            <polygon
                points="212.32 72.13 212.32 78.02 117.91 78.02 117.91 61.94 212.32 72.13"
                fill="url(#svg-under-construction-linear-gradient-21)"
            />
            <rect
                x="98.05"
                y="53.8"
                width="19.85"
                height="275.75"
                fill="url(#svg-under-construction-linear-gradient-22)"
            />
            <rect
                x="103"
                y="53.8"
                width="10.97"
                height="275.75"
                fill="url(#svg-under-construction-linear-gradient-23)"
            />
            <polygon
                points="98.05 58.6 98.05 78.41 81.24 78.41 81.24 65.4 98.05 58.6"
                fill="url(#svg-under-construction-linear-gradient-24)"
            />
            <polygon
                points="98.05 62.02 98.05 78.41 81.24 78.41 81.24 68.81 98.05 62.02"
                fill="url(#svg-under-construction-linear-gradient-25)"
            />
            <rect
                x="175.26"
                y="128.94"
            ...
            <path
                ...
                transform="translate(-1.64 -46.71)"
                opacity="0.5"
                fill="url(#svg-under-construction-linear-gradient-26)"
            />
            <path
