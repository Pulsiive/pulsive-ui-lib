...
const SvgError404: FunctionComponent = () => {
    return (
        <svg
            id="Layer_1"
            data-name="Layer 1"
        ...
        >
            <defs>
                <linearGradient
                    id="svg-error404-linear-gradient"
                    x1="156.72"
                    y1="259"
                    x2="159.63"
                    y2="341.54"
                ...
                <linearGradient
                    id="svg-error404-linear-gradient-2"
                    x1="67.7"
                    y1="231.63"
                    x2="64.79"
                    y2="116.55"
                ...
                <linearGradient
                    id="svg-error404-linear-gradient-3"
                    x1="256"
                    y1="215.77"
                    x2="254.06"
                    y2="143.58"
                    xlinkHref="#svg-error404-linear-gradient"
                />
                <linearGradient
                    id="svg-error404-linear-gradient-4"
                    x1="154.93"
                    y1="238.45"
                    x2="159.46"
                    y2="81.77"
                    xlinkHref="#svg-error404-linear-gradient-2"
                />
            </defs>
            <path
            ...
            <ellipse
                ...
                rx="157.68"
                ry="19.48"
                fill="url(#svg-error404-linear-gradient)"
            />
            <path
            ...
            <polygon
                ...
                fill="url(#svg-error404-linear-gradient-2)"
            />
            <path
            ...
            <polygon
                ...
                fill="url(#svg-error404-linear-gradient-3)"
            />
            <rect
                x="52.64"
                y="48.4"
            ...
            <rect
                ...
                height="133.37"
                rx="8.37"
                fill="url(#svg-error404-linear-gradient-4)"
            />
            <rect
                x="52.64"
                y="43.05"
